...
_AWON_PROMPT: str = (
    ...
    "DISCOVERY and LEADS — high-net-worth homeowners planning a home should search a "
    "term, find this pin, save it, and click through to the studio. Pinterest is a "
    "visual SEARCH engine: ranking is driven by keyword relevance in the title, "
    "description, and alt text — NOT by hashtags. Write the way an HNI actually "
    "searches, not the way an architect talks.\n\n"
    ...
    "connoisseur language and ranks poorly — lead with the searchable typology and "
    "let material follow. Keep the copy keyword-rich but NATURAL; do not stuff "
    "keywords, as Pinterest penalises this as spam.\n\n"
    "GEOGRAPHY: Do NOT force a location into the searchable keywords — the same pin "
    "may be shown to homeowners in India or the GCC. Lead with region-neutral "
    "typology and style. Mention a place only as the studio's own location in the "
    "sign-off (A.won, New Delhi), never as a claim about where the building stands.\n\n"
    ...
    "second. Keep to a single coherent typology — do NOT mix terms like 'farmhouse' "
    "and 'villa' in one title. May use a clean pipe structure (e.g. 'Modern "
    "Farmhouse Design | Travertine Facade'). Maximum 100 characters. No hashtags. No "
    "emoji. The title must describe THIS image — NEVER output placeholder or meta "
    "text such as 'title', 'under 100 characters', or 'JSON'.\n"
    '- "description": Two to three restrained sentences. The FIRST sentence must be '
    "search-led, repeating the core typology/style terms an HNI would type and "
    "naturally weaving in relevant terms (villa, residence, farmhouse, interior, "
    "courtyard, facade, elevation where genuinely visible). Include ONE quiet, "
    "varied signal that this is commissioned concept work a client could engage — "
    "e.g. 'A concept designed for a private residence' or a 'Concept by A.won, New "
    "Delhi' sign-off — without ever sounding promotional. End with a MAXIMUM of 3 "
    "precise hashtags chosen from what is visible: #conceptarchitecture #luxuryvilla "
    "#villadesign #farmhousedesign #interiordesign #facadedesign #poolvilla "
    "#luxuryinteriors. Use a geographic hashtag ONLY if the setting is genuinely "
    "evident. The ENTIRE description including hashtags must be 500 characters or "
    "fewer.\n"
    '- "alt_text": A factual, accessible description of exactly what is visible, '
    "written so it is useful to a screen-reader AND naturally contains the same core "
    "search keywords (typology, style, key materials, setting). No hype, no "
