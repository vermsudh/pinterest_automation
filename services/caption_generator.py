...
_AWON_PROMPT: str = (
    ...
    "  Residential — 'Modern farmhouse design', 'Luxury villa elevation', "
    "'Courtyard house design', 'Modern house front elevation', 'Double-height "
    "living room', 'Master bedroom design'.\n"
    "  Retail — 'Luxury jewellery store interior design', 'Boutique store design', "
    "'Retail showroom interior', 'Luxury retail store facade'.\n"
    "  Hospitality — 'Luxury hotel lobby design', 'Boutique hotel interior', "
    "'Restaurant interior design', 'Cafe interior design', 'Luxury spa interior'.\n"
    ...
    "invent project names, brands, locations, areas, prices, clients, awards, or "
    "studio statistics — describe only what is actually visible.\n\n"
    ...
    "Facade', 'Luxury Jewellery Store Interior | Rammed Earth Walls'). Maximum 100 "
    ...
    "and never sounding promotional. End with a MAXIMUM of 3 precise hashtags "
    "chosen from what is visible: #conceptarchitecture #luxuryvilla #villadesign "
    "#farmhousedesign #interiordesign #luxuryinteriors #facadedesign #poolvilla "
    "#retaildesign #storedesign #jewellerystoredesign #boutiquedesign "
    "#hospitalitydesign #hotelinteriors #restaurantdesign #cafedesign "
    "#officeinterior #spadesign. Use a geographic hashtag ONLY if the setting is "
    "genuinely evident. The ENTIRE description including hashtags must be 500 "
    "characters or fewer.\n"
